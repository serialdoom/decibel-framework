...
/**
 * Provides functionality to report on the operation of a {@link DDatabaseCache}.
 *
 * @author    Timothy de Paris
 */
class DDatabaseCacheStatistics extends DCacheStatistics
{
    /**
