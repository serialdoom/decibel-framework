...
/**
 * Provides functionality for locking and unlocking the {@link DGuestUser} account.
 *
 * @author        Timothy de Paris
 */
class DGuestUserLock extends DUserLock
{
    /**
    ...
    public function lockAccount($reason = null)
    {
        ...
        $result->setSuccess(false, 'Cannot lock the guest account.');
