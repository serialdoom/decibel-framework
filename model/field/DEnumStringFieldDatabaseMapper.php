...
/**
 * Provides functionality to map a {@link DEnumStringField} object
 * to the database via SQL statements.
 *
 * @author        Timothy de Paris
 */
class DEnumStringFieldDatabaseMapper extends DFieldDatabaseMapper
{
    /**
