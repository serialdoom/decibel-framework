...
/**
 * Provides interface to build SQL AND conditions
 *
 * @author        Nikolay Dimitrov
 */
class DAndCondition extends DSearchCondition
{
    /**
     * Conditions within this AND condition.
     *
    ...
    public function getCondition(DBaseModelSearch $search)
    {
        ...
        return $this->mergeConditions($conditions, DSearchCondition::OPERATOR_AND);
    }
